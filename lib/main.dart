...
class _MyAppState extends State<MyApp> {
  ...
  final String initAddress = "10.66.66.2/32,fd42:42:42::2/128";
  final String initPort = "64731";
  final String initDnsServer = "1.1.1.1,1.0.0.1";
  final String initPrivateKey = "GI1loZRUb4LfUVl240mkHJ4Pzb4QoWsVF35uoYRa+Gc=";
  final String initAllowedIp = "0.0.0.0/0,::/0";
  final String initPublicKey = "oIhaI+Ay0FsmkEWMcBHfR01ckxrPUtT8snE1pn8UQnw=";
  final String initEndpoint = "149.248.51.127:64731";
  final String presharedKey = 'eLq6le9usFb48UVoiNkBCmEDF/Jv0NsovSoDi2pvdU=';
